      ...
      >
        <div>
          <div class="flex justify-between items-start mb-4">
            ...
            <button @click.stop="deleteRoom(room.id)" class="text-slate-500 hover:text-red-500 p-1 rounded-lg hover:bg-red-500/10 transition-all">
        ...
        <button
          @click="router.push(`/rooms/${room.id}/questions`)"
          class="w-full py-2 bg-white/5 hover:bg-brand text-slate-300 hover:text-white rounded-xl transition-all border border-white/10 flex items-center justify-center gap-2 group/btn"
        >
          Manage Questions
          <svg class="h-4 w-4 transform group-hover/btn:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
